...
function getRoomById(t){var x;$.ajax({url:_ROOT_+"room/getbyid.do", type:"post", data:{"roomid":t}, async:false}).done(function (d){x=d.data;}).fail(function (){x=null;});return x;}
